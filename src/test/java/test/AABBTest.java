...
public class AABBTest {
	...
	/**
	 * This test controls the ability to update the X value by adding the
	 * desired number to the old value.
	 * 
	 */
	@Test
	...
	/**
	 * This test controls the ability to update the Y value by adding the
	 * desired number to the old value.
	 * 
	 */
	@Test
	...
	/**
	 * Checks the different conditions regarding the intersection of two
	 * bounding boxes.
	 * 
	 */
	@Test
	...
	/**
	 * Checks the different conditions regarding the intersection of two bounding boxes.
	 */
	@Test

...
public class SpriteTest {
	 ...
	 */
	/*
	 * @Test public void grow() { AABB aabb = new AABB(10, 10,10,10); Image
	 * image1 = mock(Image.class); Sprite sprite1 = new Sprite(image1, aabb);
	 * double multi = 10; assertEquals(10, aabb.getHeight()); assertEquals(10,
	 * aabb.getWidth());
	 * 
	 * sprite1.grow(multi); assertEquals(100, aabb.getHeight());

...
public abstract class Entity {
  ...
  public boolean intersectsRightScreenEdge() {
    return (this.sprite.getBoundingBox().getX() + this.sprite.getBoundingBox()
        .getWidth()) >= Game.getResX();
  }
  ...
  public boolean intersectsUnderScreenEdge() {
    return (this.sprite.getBoundingBox().getY() + this.sprite.getBoundingBox()
        .getHeight()) >= Game.getResY();
  }
